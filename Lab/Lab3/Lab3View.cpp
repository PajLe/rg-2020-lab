...
void CLab3View::DrawTopRight(CDC* pDC)
{
	...
	int prevMode = SetGraphicsMode(pDC->m_hDC, GM_ADVANCED);
	ModifyWorldTransformTranslate(pDC, 11.1 * gridSquareSize, -0.8 * gridSquareSize, false);
	ModifyWorldTransformTranslate(pDC, w / 2, h / 2, false);
	ModifyWorldTransformMirror(pDC, false, true, false);
...
void CLab3View::DrawCenterMiddle(CDC* pDC)
{
	...
	int prevMode = SetGraphicsMode(pDC->m_hDC, GM_ADVANCED);
	ModifyWorldTransformTranslate(pDC, 4.75 * gridSquareSize, 5.25 * gridSquareSize, false);
	ModifyWorldTransformTranslate(pDC, w / 2, h / 2, false);
	ModifyWorldTransformMirror(pDC, true, false, false);
	ModifyWorldTransformRotate(pDC, 132, false);
	ModifyWorldTransformTranslate(pDC, -w / 2, -h / 2, false);
	CDC* memDC = new CDC();
	memDC->CreateCompatibleDC(pDC);
	memDC->SelectObject(mask);
...
void CLab3View::DrawCenterRight(CDC* pDC)
{
	...
	int prevMode = SetGraphicsMode(pDC->m_hDC, GM_ADVANCED);
	ModifyWorldTransformTranslate(pDC, 10.7 * gridSquareSize, 5.2 * gridSquareSize, false);
	ModifyWorldTransformTranslate(pDC, w / 2, h / 2, false);
	ModifyWorldTransformMirror(pDC, false, true, false);
	ModifyWorldTransformRotate(pDC, -56, false);
	ModifyWorldTransformTranslate(pDC, -w / 2, -h / 2, false);
	CDC* memDC = new CDC();
	memDC->CreateCompatibleDC(pDC);
	memDC->SelectObject(mask);
...
void CLab3View::DrawBottomLeft(CDC* pDC)
{
	...
	int prevMode = SetGraphicsMode(pDC->m_hDC, GM_ADVANCED);
	ModifyWorldTransformTranslate(pDC, -1.45 * gridSquareSize, 10.8 * gridSquareSize, false);
	ModifyWorldTransformTranslate(pDC, w / 2, h / 2, false);
	ModifyWorldTransformMirror(pDC, true, true, false);
	ModifyWorldTransformRotate(pDC, 87, false);
	ModifyWorldTransformTranslate(pDC, -w / 2, -h / 2, false);
	CDC* memDC = new CDC();
	memDC->CreateCompatibleDC(pDC);
	memDC->SelectObject(mask);
...
void CLab3View::DrawBottomMiddle(CDC* pDC)
{
	...
	int prevMode = SetGraphicsMode(pDC->m_hDC, GM_ADVANCED);
	ModifyWorldTransformTranslate(pDC, 5.1 * gridSquareSize, 10.6 * gridSquareSize, false);
	ModifyWorldTransformTranslate(pDC, w / 2, h / 2, false);
	ModifyWorldTransformMirror(pDC, true, false, false);
	ModifyWorldTransformRotate(pDC, -52, false);
	ModifyWorldTransformTranslate(pDC, -w / 2, -h / 2, false);
	CDC* memDC = new CDC();
	memDC->CreateCompatibleDC(pDC);
	memDC->SelectObject(mask);
