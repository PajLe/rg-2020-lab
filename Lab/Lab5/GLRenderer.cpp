...
void CGLRenderer::DrawCylinderPartOfTheBase()
{
...
void CGLRenderer::DrawVase()
{
	...
	nextR = DrawVasePart5(nextR, fullConeHeight, 0.3f); // upside down
	glPopMatrix();
	...
	glTranslatef(0.0f, 0.3f, 0.0f);
	glRotatef(180, 0.0f, 0.0f, 1.0f);
	nextR = DrawVasePart7(nextR, fullConeHeight, 0.3f); // upside down
	glPopMatrix();
	...
	glTranslatef(0.0f, 0.3f, 0.0f);
	glRotatef(180, 0.0f, 0.0f, 1.0f);
	nextR = DrawVasePart8(nextR, fullConeHeight, 0.3f); // upside down
	glPopMatrix();

	glTranslatef(0.0f, 0.3f, 0.0f);
	nextR = DrawVasePart9(nextR, fullConeHeight, 0.3f);

	glTranslatef(0.0f, 0.3f, 0.0f);
	glPushMatrix();
	glTranslatef(0.0f, 0.3f, 0.0f);
	glRotatef(180, 0.0f, 0.0f, 1.0f);
	nextR = DrawVasePart10(nextR, fullConeHeight, 0.3f); // upside down
	glPopMatrix();
	...
	glTranslatef(0.0f, 0.3f, 0.0f);
	glRotatef(180, 0.0f, 0.0f, 1.0f);
	nextR = DrawVasePart11(nextR, fullConeHeight, 0.3f); // upside down
	glPopMatrix();

	glTranslatef(0.0f, 0.3f, 0.0f);
	nextR = DrawVasePart12(nextR, fullConeHeight, 0.3f);

	glTranslatef(0.0f, 0.3f, 0.0f);
	glPushMatrix();
	glTranslatef(0.0f, 0.3f, 0.0f);
	glRotatef(180, 0.0f, 0.0f, 1.0f);
	nextR = DrawVasePart13(nextR, fullConeHeight, 0.3f); // upside down
	glPopMatrix();
	...
	glTranslatef(0.0f, 0.3f, 0.0f);
	glRotatef(180, 0.0f, 0.0f, 1.0f);
	nextR = DrawVasePart14(nextR, fullConeHeight, 0.3f); // upside down
	glPopMatrix();
}
...
float CGLRenderer::DrawVasePart1(float fullConeHeight, float partConeHeight)
{
	...
	return DrawConePart(1.5f, fullConeHeight, partConeHeight);
}

float CGLRenderer::DrawVasePart2(float baseR, float fullConeHeight, float partConeHeight)
{
	GLMaterial partMaterial;
	...
	partMaterial.SelectFront();
	return DrawConePart(baseR, fullConeHeight, partConeHeight);
}

float CGLRenderer::DrawVasePart3(float baseR, float cylHeight) // cylinder
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	partMaterial.SetAmbient(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	...
	partMaterial.SelectFront();
	return DrawCylinderPart(baseR, cylHeight);
}

float CGLRenderer::DrawVasePart4(float baseR, float cylHeight) // cylinder
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
	partMaterial.SetAmbient(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart5(float smallerR, float fullConeHeight, float partConeHeight) // upside down
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	partMaterial.SetAmbient(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	...
	partMaterial.SelectFront();
	return DrawUpsideDownConePart(smallerR, fullConeHeight, partConeHeight);
}

float CGLRenderer::DrawVasePart6(float baseR, float fullConeHeight, float partConeHeight)
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
	partMaterial.SetAmbient(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart7(float smallerR, float fullConeHeight, float partConeHeight) // uspide down
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	partMaterial.SetAmbient(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart8(float smallerR, float fullConeHeight, float partConeHeight) // uspide down
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
	partMaterial.SetAmbient(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart9(float baseR, float fullConeHeight, float partConeHeight)
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	partMaterial.SetAmbient(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart10(float smallerR, float fullConeHeight, float partConeHeight) // upside down
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
	partMaterial.SetAmbient(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart11(float smallerR, float fullConeHeight, float partConeHeight) // upside down
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	partMaterial.SetAmbient(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart12(float baseR, float fullConeHeight, float partConeHeight)
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
	partMaterial.SetAmbient(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart13(float smallerR, float fullConeHeight, float partConeHeight) // upside down
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
	partMaterial.SetAmbient(97 / 255.0, 97 / 255.0, 146 / 255.0, 1.0f);
...
float CGLRenderer::DrawVasePart14(float smallerR, float fullConeHeight, float partConeHeight) // upside down
{
	GLMaterial partMaterial;
	partMaterial.SetDiffuse(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
	partMaterial.SetAmbient(67 / 255.0, 67 / 255.0, 144 / 255.0, 1.0f);
...
float CGLRenderer::DrawUpsideDownConePart(float smallerR, float fullConeHeight, float partConeHeight)
{
	const u_short quads = 40;
	float otherPartHeight = fullConeHeight - partConeHeight;
	float r1 = smallerR;
	float r = r1 * fullConeHeight / otherPartHeight;
	float L = sqrt(pow(fullConeHeight, 2) + pow(r, 2));
	float L1 = sqrt(pow(partConeHeight, 2) + pow(r1, 2));
	float ny = r / L;
...
float CGLRenderer::DrawConePart(float baseR, float fullConeHeight, float partConeHeight)
{
	const u_short quads = 40;
	float otherPartHeight = fullConeHeight - partConeHeight;
	float r = baseR;
	float r1 = otherPartHeight * r / fullConeHeight; // r1/r == h1/h
	float L = sqrt(pow(fullConeHeight, 2) + pow(r, 2));
	float L1 = sqrt(pow(partConeHeight, 2) + pow(r1, 2));
	float ny = r / L;
	float nr = fullConeHeight / L;
...
float CGLRenderer::DrawCylinderPart(float baseR, float cylHeight)
{
	const u_short quads = 40;
