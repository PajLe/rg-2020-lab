...
float CGLRenderer::DrawVasePart5(float smallerR, float fullConeHeight, float partConeHeight) // upside down
{
	...
	float otherPartHeight = fullHeight - partHeight;
	float r1 = smallerR;
	float r = r1 * fullHeight / otherPartHeight;
	float L = sqrt(pow(fullHeight, 2) + pow(r, 2));
	float L1 = sqrt(pow(partHeight, 2) + pow(r1, 2));
	float ny = r / L;
	float nr = fullHeight / L;
...
float CGLRenderer::DrawVasePart10(float smallerR, float fullConeHeight, float partConeHeight)
{
	const u_short quads = 40;
	float fullHeight = fullConeHeight;
	float partHeight = partConeHeight;
...
float CGLRenderer::DrawVasePart11(float smallerR, float fullConeHeight, float partConeHeight)
{
	const u_short quads = 40;
	float fullHeight = fullConeHeight;
	float partHeight = partConeHeight;
...
float CGLRenderer::DrawVasePart13(float smallerR, float fullConeHeight, float partConeHeight)
{
	const u_short quads = 40;
	float fullHeight = fullConeHeight;
	float partHeight = partConeHeight;
...
float CGLRenderer::DrawVasePart14(float smallerR, float fullConeHeight, float partConeHeight)
{
	const u_short quads = 40;
	float fullHeight = fullConeHeight;
	float partHeight = partConeHeight;
